...
<div id="item-actions">
	...
	<?php if ( bp_group_is_visible() ) : ?>
		...
		<h3><?php _e( 'Group Admins', 'wonderflux' ); ?></h3>
		...
		if ( bp_group_has_moderators() ) :
			...
			<h3><?php _e( 'Group Mods' , 'wonderflux' ); ?></h3>
...
<div id="item-header-content">
	...
	<span class="activity"><?php printf( __( 'active %s', 'wonderflux' ), bp_get_group_last_active() ); ?></span>
