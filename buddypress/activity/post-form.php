...
<form action="<?php bp_activity_post_form_action(); ?>" method="post" id="whats-new-form" name="whats-new-form" role="complementary">
	...
	<div id="whats-new-content">
		<div id="whats-new-textarea">
			<label for="whats-new" class="bp-screen-reader-text"><?php _e( 'Post what\'s new', 'wonderflux' ); ?></label>
		...
		<div id="whats-new-options">
			<div id="whats-new-submit">
				<input type="submit" name="aw-whats-new-submit" id="aw-whats-new-submit" value="<?php esc_attr_e( 'Post Update', 'wonderflux' ); ?>" />
			</div>
			...
			<?php if ( bp_is_active( 'groups' ) && !bp_is_my_profile() && !bp_is_group() ) : ?>
				...
				<div id="whats-new-post-in-box">
					...
					<?php _e( 'Post in', 'wonderflux' ); ?>:

					<label for="whats-new-post-in" class="bp-screen-reader-text"><?php _e( 'Post in', 'wonderflux' ); ?></label>
					<select id="whats-new-post-in" name="whats-new-post-in">
						<option selected="selected" value="0"><?php _e( 'My Profile', 'wonderflux' ); ?></option>
