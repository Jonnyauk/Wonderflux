...
<script id="tmpl-bp-avatar-delete" type="text/html">
	<# if ( 'user' === data.object ) { #>
		...
		<p><a class="button edit" id="bp-delete-avatar" href="#" title="<?php esc_attr_e( 'Delete Profile Photo', 'wonderflux' ); ?>"><?php esc_html_e( 'Delete My Profile Photo', 'wonderflux' ); ?></a></p>
	<# } else if ( 'group' === data.object ) { #>
		...
		<p><a class="button edit" id="bp-delete-avatar" href="#" title="<?php esc_attr_e( 'Delete Group Profile Photo', 'wonderflux' ); ?>"><?php esc_html_e( 'Delete Group Profile Photo', 'wonderflux' ); ?></a></p>
	<# } else { #>
