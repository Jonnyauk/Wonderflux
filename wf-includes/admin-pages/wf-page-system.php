...
echo '<h1>' . esc_html__('Constants you can define in your child theme', 'wonderflux') . '</h1>';

echo '<h3>' . esc_html__('Wonderflux file paths', 'wonderflux') . '</h3>';
...
echo '<h3>' . esc_html__('Wonderflux debug and Flux Layout CSS framework control', 'wonderflux') . '</h3>';
