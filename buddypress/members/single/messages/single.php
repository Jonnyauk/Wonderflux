		...
		<p id="message-recipients">
			<span class="highlight">
				...
				<?php if ( bp_get_thread_recipients_count() <= 1 ) : ?>
					...
					<?php _e( 'You are alone in this conversation.', 'wonderflux' ); ?>

				<?php elseif ( bp_get_max_thread_recipients_to_list() <= bp_get_thread_recipients_count() ) : ?>

					<?php printf( __( 'Conversation between %s recipients.', 'wonderflux' ), number_format_i18n( bp_get_thread_recipients_count() ) ); ?>

				<?php else : ?>

					<?php printf( __( 'Conversation between %s and you.', 'wonderflux' ), bp_get_thread_recipients_list() ); ?>

				<?php endif; ?>

			</span>

			<a class="button confirm" href="<?php bp_the_thread_delete_link(); ?>" title="<?php esc_attr_e( "Delete Conversation", 'wonderflux' ); ?>"><?php _e( 'Delete', 'wonderflux' ); ?></a>
		</p>
			...
			<div class="message-box">
				...
				<div class="message-metadata">
					...
					<div class="avatar-box">
						...
						<strong><?php _e( 'Send a Reply', 'wonderflux' ); ?></strong>
					</div>
				...
				<div class="message-content">
					...
					<label for="message_content" class="bp-screen-reader-text"><?php _e( 'Reply to Message', 'wonderflux' ); ?></label>
					...
					<div class="submit">
						<input type="submit" name="send" value="<?php esc_attr_e( 'Send Reply', 'wonderflux' ); ?>" id="send_reply_button"/>
					</div>
